"""
Django settings for paulomoreno project.
...
SECRET_KEY = 'rj*c61pg%q+e#+ml4d5s4eg50qs%re5m5%nc1l-%4c5&1t3z)h'
...
ROOT_URLCONF = 'paulomoreno.urls'

WSGI_APPLICATION = 'paulomoreno.wsgi.application'
